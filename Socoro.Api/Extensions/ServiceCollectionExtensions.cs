using Socoro.Api.Services;
using Socoro.Application.DTOs.Settings;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Socoro.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
