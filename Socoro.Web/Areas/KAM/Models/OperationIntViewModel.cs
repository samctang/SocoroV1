namespace Socoro.Web.Areas.KAM.Models
{
    public class OperationIntViewModel
    {
        ...
        public OperationBookingViewModel OperationBookingViewModel { get; set; }
        ...
        public OperationProcessViewModel OperationProcessViewModel { get; set; }
        public OperationTaskViewModel OperationTaskViewModel { get; set; }
